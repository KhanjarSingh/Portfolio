...
const Hero = () => {
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-primary/20 rounded-full blur-[120px] -z-10 opacity-50 animate-pulse" style={{ animationDuration: '4s' }} />
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 text-center z-10">
                <motion.div
                    ...
                    className="mb-8"
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-muted-foreground backdrop-blur-sm shadow-inner transition-all hover:bg-white/10 hover:border-white/20 hover:text-white cursor-default">
                        <Terminal size={14} className="text-primary" />
                        <span className="font-mono">Hello World, I'm</span>
                    </div>
                </motion.div>
                ...
                <motion.h1
                    ...
                    className="text-6xl md:text-8xl font-bold font-heading tracking-tight mb-6"
                >
                    Parth <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-violet-400 to-indigo-400">Tandalwade</span>
                </motion.h1>
                ...
                >
                    CS Undergraduate & <span className="text-foreground">Full Stack Developer</span>
                </motion.p>
                ...
                >
                    Building digital experiences with code and creativity. Specializing in scalable web applications, AI integration, and solving complex problems.
                </motion.p>
                ...
                >
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                        <a
                            href="#projects"
                            className="group relative inline-flex h-14 items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 px-10 font-bold text-white shadow-xl shadow-blue-500/50 transition-all duration-300 hover:from-blue-500 hover:via-blue-400 hover:to-cyan-400 hover:scale-105 hover:shadow-[0_0_60px_rgba(59,130,246,0.8)] active:scale-95 border border-blue-400/20"
                        >
                            <span className="mr-2 text-lg relative z-10 font-bold text-white">View Work</span>
                            <ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1 relative z-10 text-white" />
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
                            { icon: <Linkedin size={20} />, href: "https://www.linkedin.com/in/parth-tandalwade-295882323/", color: "hover:text-[#0077b5]", label: "LinkedIn" },
                            { icon: <Github size={20} />, href: "https://github.com/KhanjarSingh", color: "hover:text-white", label: "GitHub" },
                        ].map((social, index) => (
                            <a
                                key={index}
                                href={social.href}
                                ...
                                className={`p-3 rounded-full bg-white/5 border border-white/5 text-muted-foreground transition-all hover:scale-110 hover:bg-white/10 ${social.color}`}
                        ...
                        {[
                            { icon: <CodeforcesIcon className="w-5 h-5" />, href: "https://codeforces.com/profile/parth_0007", color: "hover:text-[#1F8ACB]", label: "Codeforces" },
                            { icon: <LeetCodeIcon className="w-5 h-5" />, href: "https://leetcode.com/u/parth_0007/", color: "hover:text-[#FFA116]", label: "LeetCode" },
                            { icon: <CodeChefIcon className="w-5 h-5" />, href: "https://www.codechef.com/users/parth_0007", color: "hover:text-[#5B4638]", label: "CodeChef" },
                        ].map((platform, index) => (
                            <a
                                key={index}
                                href={platform.href}
                                target="_blank"
                                rel="noopener noreferrer"
                                className={`p-3 rounded-full bg-white/5 border border-white/5 text-muted-foreground transition-all hover:scale-110 hover:bg-white/10 ${platform.color}`}
